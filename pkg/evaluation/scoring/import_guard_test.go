...
// TestStablePackagesDoNotImportExperimental enforces that only pkg/evaluation/scoring/jev may import dspy-go experimental APIs.
func TestStablePackagesDoNotImportExperimental(t *testing.T) {
	...
	jevRoot := filepath.Join(pkgRoot, "jev")
